...
const website = "https://kenz-innovations-web-app.vercel.app/"

export const metadataObj: Metadata = {
    title: title,
    description: description,
    generator: "Next.js",
    applicationName: "Kenz Innovations",
    ...
    authors: [
        { name: "Kenz Innovations", url: website },
